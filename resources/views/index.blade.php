...
<head>
	  ...
	  <!-- Favicons -->
	  <link href="{{ asset('user/assets/img/favicons.png') }}" rel="icon">
	  {{-- <link href="{{ asset('user/assets/img/apple-touch-icon.png') }}" rel="apple-touch-icon"> --}}
	  <link href="{{ asset('user/assets/img/favicons.png') }}" rel="apple-touch-icon">
...
=======
				<img style="margin-right: -4px; width: 50px ; height 50px;" src="{{ asset('user/assets/img/iconTest/logo.png') }}" alt="">  
				<span style="margin-top:10px ;">4TANI</span>
>>>>>>> 3fa05f260fb3ae2b43dc1b9ef9eb1ac4d67812ed
				</a>
			</div>
