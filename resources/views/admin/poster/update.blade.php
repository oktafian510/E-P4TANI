...
<div class="card-body">
    <form action="{{ url('adminPoster/'.$model->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row">
            ...
            <div class="form-group">
                ...
                <input type="text" name="title"  id="title" class="form-control" placeholder="Please insert..." value="{{ $model->title }}">
            </div>
            </div>
        </div>
        <div class="row">
